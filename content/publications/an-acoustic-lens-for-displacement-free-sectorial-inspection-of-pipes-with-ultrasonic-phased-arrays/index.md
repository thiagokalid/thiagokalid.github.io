---
title: "An acoustic lens for displacement-free sectorial inspection
of pipes with ultrasonic phased arrays"
authors:
- Gustavo P. Pires
- me
- Tatiana A. Prado
...
hugoblox:
  ids:
    doi: 10.1016/j.ndteint.2025.103459

links:
  - type: preprint
    provider: ssrn
    url: https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5224648

  - type: custom
    label: Code & Dataset
    url: https://zenodo.org/records/15411689

# Featured image
# To use, add an image named `featured.jpg/png` to your page's folder. 
image:
  caption: 'Image credit: [**Pires et al 2025**](https://unsplash.com/photos/jdD8gXaTZsc)'
  focal_point: ""
  preview_only: false
